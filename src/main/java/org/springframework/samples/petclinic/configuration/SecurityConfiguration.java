...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/player/**").hasAnyAuthority("user", "admin")
				.antMatchers("/games/playing").hasAnyAuthority("admin")
				.antMatchers("/games/playingP").hasAnyAuthority("admin")
				.antMatchers("/games/finished").hasAnyAuthority("admin")
				.antMatchers("/games/**").hasAnyAuthority("user", "admin")
				.antMatchers("/users/**").hasAnyAuthority("user", "admin")
				.antMatchers("/registeredUser/**").hasAnyAuthority("admin")
				.antMatchers("/registeredUser/delete/**").hasAnyAuthority("admin")
				.antMatchers("/error").permitAll()
				.anyRequest().denyAll()
				.and()
				 	.formLogin()
				 	.loginPage("/login")
					.defaultSuccessUrl("/users/{userId}")
					.permitAll()
